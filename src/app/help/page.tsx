...
import { useAppEmoji } from '@/components/AppIcon';
    ...
    <PageTransition>
      ...
      <div className="space-y-4">
        ...
        <div className="card p-4">
          <h3 className="text-sm font-semibold text-[#3d342b] mb-2">{E('help')} 关于账单管理</h3>
        ...
        {/* 各功能 */}
        <div className="card p-4">
          <h3 className="text-sm font-semibold text-[#3d342b] mb-2">{E('dashboard')} 仪表盘</h3>
          <p className="text-[13px] text-[#6b5d52] leading-relaxed">
        ...
        <div className="card p-4">
          <h3 className="text-sm font-semibold text-[#3d342b] mb-2">{E('transactions')} 记账</h3>
          <p className="text-[13px] text-[#6b5d52] leading-relaxed">
        ...
        <div className="card p-4">
          <h3 className="text-sm font-semibold text-[#3d342b] mb-2">{E('reports')} 报表</h3>
          <p className="text-[13px] text-[#6b5d52] leading-relaxed">
        ...
        <div className="card p-4">
          <h3 className="text-sm font-semibold text-[#3d342b] mb-2">{E('recurring')} 周期账单</h3>
          <p className="text-[13px] text-[#6b5d52] leading-relaxed">
        ...
        <div className="card p-4">
          <h3 className="text-sm font-semibold text-[#3d342b] mb-2">{E('import')} 数据导入</h3>
          <p className="text-[13px] text-[#6b5d52] leading-relaxed">
            设置 → 数据导入，支持微信和支付宝账单：
          </p>
        ...
        <div className="card p-4">
          <h3 className="text-sm font-semibold text-[#3d342b] mb-2">{E('rules')} 自动分类规则</h3>
          <p className="text-[13px] text-[#6b5d52] leading-relaxed">
        ...
        <div className="card p-4">
          <h3 className="text-sm font-semibold text-[#3d342b] mb-2">{E('backup')} 数据备份</h3>
          <p className="text-[13px] text-[#6b5d52] leading-relaxed">
        ...
        <div className="card p-4">
          <h3 className="text-sm font-semibold text-[#3d342b] mb-2">{E('appearance')} 外观</h3>
          <p className="text-[13px] text-[#6b5d52] leading-relaxed">
