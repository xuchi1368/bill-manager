    ...
    <PageTransition>
      ...
      <div className="space-y-4">
        ...
        <div className="card p-4">
          <h3 className="text-sm font-semibold text-[#3d342b] mb-2"><AppIcon name="help" size={16} /> 关于账单管理</h3>
        ...
        {/* 各功能 */}
        <div className="card p-4">
          <h3 className="text-sm font-semibold text-[#3d342b] mb-2"><AppIcon name="dashboard" size={16} /> 仪表盘</h3>
          <p className="text-[13px] text-[#6b5d52] leading-relaxed">
        ...
        <div className="card p-4">
          <h3 className="text-sm font-semibold text-[#3d342b] mb-2"><AppIcon name="transactions" size={16} /> 记账</h3>
          <p className="text-[13px] text-[#6b5d52] leading-relaxed">
        ...
        <div className="card p-4">
          <h3 className="text-sm font-semibold text-[#3d342b] mb-2"><AppIcon name="reports" size={16} /> 报表</h3>
          <p className="text-[13px] text-[#6b5d52] leading-relaxed">
        ...
        <div className="card p-4">
          <h3 className="text-sm font-semibold text-[#3d342b] mb-2"><AppIcon name="recurring" size={16} /> 周期账单</h3>
          <p className="text-[13px] text-[#6b5d52] leading-relaxed">
        ...
        <div className="card p-4">
          <h3 className="text-sm font-semibold text-[#3d342b] mb-2"><AppIcon name="import" size={16} /> 数据导入</h3>
          <p className="text-[13px] text-[#6b5d52] leading-relaxed">
            设置 → 数据导入，支持微信和支付宝账单：
          </p>
        ...
        <div className="card p-4">
          <h3 className="text-sm font-semibold text-[#3d342b] mb-2"><AppIcon name="rules" size={16} /> 自动分类规则</h3>
          <p className="text-[13px] text-[#6b5d52] leading-relaxed">
        ...
        <div className="card p-4">
          <h3 className="text-sm font-semibold text-[#3d342b] mb-2"><AppIcon name="backup" size={16} /> 数据备份</h3>
          <p className="text-[13px] text-[#6b5d52] leading-relaxed">
        ...
        <div className="card p-4">
          <h3 className="text-sm font-semibold text-[#3d342b] mb-2"><AppIcon name="appearance" size={16} /> 外观</h3>
          <p className="text-[13px] text-[#6b5d52] leading-relaxed">
